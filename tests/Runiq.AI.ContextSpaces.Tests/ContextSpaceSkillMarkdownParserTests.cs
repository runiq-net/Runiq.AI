...
public sealed class ContextSpaceSkillMarkdownParserTests
{
    ...
    {
        // Bu test, geçerli SKILL.md içeriginin skill modeline dönüstürülebildigini dogrular.
    ...
    {
        // Bu test, front matter içermeyen SKILL.md içeriginin kabul edilmedigini dogrular.
        const string content = """
            # Code Review
    ...
    {
        // Bu test, name alani olmayan SKILL.md içeriginin kabul edilmedigini dogrular.
        const string content = """
            ---
    ...
    {
        // Bu test, front matter sonrasi yönerge içerigi bos olan SKILL.md dosyasinin kabul edilmedigini dogrular.
        const string content = """
            ---
            name: code-review
            ---
