...
namespace Runiq.ContextTravelGuide.Tools;
...
public sealed class WeatherTool : IRuniqTool<WeatherInput, WeatherOutput>
{
    ...
    CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (location is null)
            {
                return Unknown(city, $"{city} için hava durumu konumu bulunamadı.");
            }
            ...
            if (weather is null)
            {
                return Unknown(location.Name, $"{location.Name} için güncel hava durumu alınamadı.");
            }
            ...
            return new WeatherOutput(
                ...
                Condition: condition,
                Summary: $"{location.Name} için hava {ToTurkishCondition(condition)} ve yaklaşık {temperature} derece.");
        }
        ...
        {
            return Unknown(city, $"{city} için hava durumu servisine ulaşılamadı. Planlama genel hava varsayımı olmadan yapılmalıdır.");
        }
    }
    ...
    private static HttpClient CreateHttpClient()
    {
        ...
        httpClient.DefaultRequestHeaders.UserAgent.ParseAdd(
            "Runiq.ContextTravelGuide.Sample/1.0");
