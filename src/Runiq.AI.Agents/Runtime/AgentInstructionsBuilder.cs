...
/// <summary>
/// Agent sistem yönergelerini runtime context bilgileriyle zenginlestirir.
/// </summary>
internal static class AgentInstructionsBuilder
{
    /// <summary>
    /// Agent'in temel yönergelerini, bagli context space, skill yönergeleri ve source arama sonuçlariyla birlestirir.
    /// </summary>
