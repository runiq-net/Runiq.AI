...
/// <summary>
/// Stream olarak gelen agent execution event'lerinden tamamlanmış AgentExecutionResult üretir.
/// </summary>
public sealed class AgentExecutionResultBuilder
{
    ...
    /// <summary>
    /// Toplanan event'lerden tamamlanmış agent execution result üretir.
    /// </summary>
