...
/// <summary>
/// Context space içinde agent'in erisebilecegi bir bilgi kaynagini temsil eder.
/// </summary>
public sealed class ContextSpaceSource
{
    /// <summary>
    /// Yeni bir context space source örnegi olusturur.
    /// </summary>
    ...
    /// <summary>
    /// Kaynak için benzersiz teknik kimligi ifade eder.
    /// </summary>
    public string Id { get; }

    /// <summary>
    /// Dashboard ve metadata çiktilarinda gösterilecek okunabilir kaynak adini ifade eder.
    /// </summary>
    public string Name { get; }

    /// <summary>
    /// Kaynagin türünü ifade eder.
    /// </summary>
    public ContextSpaceSourceKind Kind { get; }

    /// <summary>
    /// Kaynagin okunabilir açiklamasini ifade eder.
    /// </summary>
    public string? Description { get; }

    /// <summary>
    /// Yerel dosya sistemi kaynagi için kök klasör yolunu döner.
    /// </summary>
    public string? Path { get; }

    /// <summary>
    /// S3 uyumlu object storage kaynagi için bucket adini döner.
    /// </summary>
    public string? BucketName { get; }

    /// <summary>
    /// S3 uyumlu object storage kaynagi için prefix degerini döner.
    /// </summary>
    public string? Prefix { get; }

    /// <summary>
    /// Yerel dosya sisteminden okunacak bir context source olusturur.
    /// </summary>
    ...
    /// <summary>
    /// S3 uyumlu object storage üzerinden okunacak bir context source olusturur.
    /// </summary>
