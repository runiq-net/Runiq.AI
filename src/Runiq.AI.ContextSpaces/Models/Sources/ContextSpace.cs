using Runiq.AI.ContextSpaces.Builders;
using Runiq.AI.ContextSpaces.Models.Skills;

namespace Runiq.AI.ContextSpaces.Models.Sources;

/// <summary>
/// Bir agent'in görev yaparken erisebilecegi bilgi, kaynak ve politika sinirini temsil eder.
/// </summary>
public sealed class ContextSpace
{
    ...
    /// <summary>
    /// Context space için benzersiz teknik kimligi ifade eder.
    /// </summary>
    public string Id { get; }

    /// <summary>
    /// Dashboard ve metadata çiktilarinda gösterilecek okunabilir adi ifade eder.
    /// </summary>
    public string Name { get; }

    /// <summary>
    /// Context space'in amacini açiklayan istege bagli metni ifade eder.
    /// </summary>
    public string? Description { get; }

    /// <summary>
    /// Context space içinde tanimli bilgi kaynaklarini ifade eder.
    /// </summary>
    public IReadOnlyList<ContextSpaceSource> Sources => _sources;

    /// <summary>
    /// Baglam alanina bagli skill kaynaklarini döner.
    /// </summary>
    public IReadOnlyList<ContextSpaceSkillSource> SkillSources => skillSources;

    /// <summary>
    /// Yeni bir context space örnegi olusturur.
    /// </summary>
    /// <param name="id">Context space için benzersiz teknik kimlik.</param>
    /// <param name="name">Context space için okunabilir ad.</param>
    /// <param name="description">Context space'in istege bagli açiklamasi.</param>
    public ContextSpace(
        string id,
        string name,
    ...
    /// <summary>
    /// Context space'e yeni bir bilgi kaynagi ekler.
    /// </summary>
    /// <param name="source">Eklenecek bilgi kaynagi.</param>
    /// <returns>Akici yapilandirma için mevcut context space örnegi.</returns>
    ...
    /// <summary>
    /// Baglam alanina skill kaynaklari ekler.
    /// </summary>
    ...
    /// <summary>
    /// Context space'e bilgi kaynaklari ekler.
    /// </summary>
