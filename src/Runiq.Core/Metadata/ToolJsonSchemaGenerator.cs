...
/// <summary>
/// Tool input ve output CLR tiplerinden Dashboard tarafından kullanılacak basit JSON schema üretir.
/// </summary>
internal static class ToolJsonSchemaGenerator
{
    ...
    /// <summary>
    /// Verilen input tipinin form alanı gerektirip gerektirmediğini döner.
    /// </summary>
